...
MultiLevelFrameDecoderImpl::MultiLevelFrameDecoderImpl() :
    ...
    _decoder1           (true, -1.0, 128, 256, 512, 1024, 16, 16, 32, 64, 5, 5, ExpandingArray<2>{2, 2}),
    _decoder2           (false, 0.0, 1024, 512, 512, 512, 16, 16, 64, 64, 10, 15,
                         ExpandingArray<2>{5, 4}, ExpandingArray<2>{3, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder3           (false, 1.0, 512, 512, 512, 512, 16, 16, 64, 64, 20, 15,
                         ExpandingArray<2>{3, 4}, ExpandingArray<2>{1, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder4           (false, 2.0, 512, 512, 512, 256, 16, 16, 64, 64, 40, 30,
                         ExpandingArray<2>{4, 4}, ExpandingArray<2>{2, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder5           (false, 3.0, 256, 256, 256, 128, 8, 8, 64, 64, 80, 60,
                         ExpandingArray<2>{4, 4}, ExpandingArray<2>{2, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder6           (false, 4.0, 128, 128, 128, 64, 8, 8, 32, 32, 160, 120,
                         ExpandingArray<2>{4, 4}, ExpandingArray<2>{2, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder7           (false, 5.0, 64, 64, 64, 32, 8, 8, 16, 16, 320, 240,
                         ExpandingArray<2>{4, 4}, ExpandingArray<2>{2, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder8           (false, 6.0, 32, 32, 32, 32, 8, 8, 8, 8, 640, 480,
                         ExpandingArray<2>{4, 4}, ExpandingArray<2>{2, 2}, Slice(1, -1, None), Slice(1, -1, None))
{
