...
MultiLevelFrameDecoderImpl::MultiLevelFrameDecoderImpl() :
    ...
    _decoder1               ("CTC", 0.0, 512, 256, 1024, 2, 3, 32, 64, 2, 4),
    _decoder2               ("CTC", 1.0, 256, 128, 1024, 2, 1, 16, 32, 2, 4),
    _decoder3               ("CC", 2.0, 128, 64, 1024, 2, 2, 8, 16, 2, 8),
    _decoder4               ("CC", 3.0, 64, 32, 1024, 2, 2, 4, 8, 4, 8),
    _decoder5               ("CC", 4.0, 32, 16, 1024, 2, 2, 2, 4, 4, 16),
