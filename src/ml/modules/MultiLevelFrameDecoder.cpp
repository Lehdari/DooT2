...
MultiLevelFrameDecoderImpl::MultiLevelFrameDecoderImpl() :
    ...
    _decoder1           (-1.0, 128, 256, 512, 1024, 8, 8, 64, 128, 5, 5, ExpandingArray<2>{2, 2}),
    _decoder2           (0.0, 1024, 1024, 1024, 1024, 8, 8, 256, 256, 10, 15,
                         ExpandingArray<2>{5, 4}, ExpandingArray<2>{3, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder3           (1.0, 1024, 1024, 1024, 512, 8, 8, 256, 256, 20, 15,
                         ExpandingArray<2>{3, 4}, ExpandingArray<2>{1, 2}, Slice(1, -1, None), Slice(1, -1, None)),
    _decoder4           (2.0, 512, 512, 512, 256, 8, 8, 128, 128, 40, 30,
