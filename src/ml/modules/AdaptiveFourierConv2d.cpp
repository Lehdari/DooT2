//
// Project: DooT2
// File: AdaptiveFourierConv2d.cpp
//
...
AdaptiveFourierConv2dImpl::AdaptiveFourierConv2dImpl(
    int inputChannels,
    int outputChannels,
    int contextChannels,
    ...
    _convLocal              (_localInputChannels, _localOutputChannels, contextChannels, std::vector<long>{3,3},
                             groups, filterBankSize, std::vector<long>{1,1,1,1}, normalInitializationStd,
                             useReflectionPadding),
    _convLocalGlobal        (_localInputChannels, _globalOutputChannels, contextChannels, std::vector<long>{3,3},
                             groups, filterBankSize, std::vector<long>{1,1,1,1}, normalInitializationStd,
                             useReflectionPadding),
    _convGlobalLocal        (_globalInputChannels, _localOutputChannels, contextChannels, std::vector<long>{3,3},
                             groups, filterBankSize, std::vector<long>{1,1,1,1}, normalInitializationStd,
                             useReflectionPadding),
    _convGlobal1            (nn::Conv2dOptions(_globalInputChannels, _globalInputChannels/2, {1,1}).bias(false)),
    _convGlobal2            (_globalInputChannels, _globalInputChannels, contextChannels, std::vector<long>{1,1},
                             1, filterBankSize, std::vector<long>{0,0,0,0}, normalInitializationStd),
...
torch::Tensor AdaptiveFourierConv2dImpl::forward(const torch::Tensor& x, const torch::Tensor& context)
{
    ...
    torch::Tensor local2 = gelu(_bnLocalMerge(_convLocal(local, context) + _convGlobalLocal(global, context)), "tanh");
    ...
    global = gelu(_bnGlobal2(_convGlobal2(global, context)));
    ...
    global2 = gelu(_bnGlobalMerge(global + _convLocalGlobal(local, context)), "tanh");
