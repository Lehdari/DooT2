//
// Project: DooT2
// File: AdaptiveResNetConvBlock.cpp
//
...
AdaptiveResNetConvBlockImpl::AdaptiveResNetConvBlockImpl(
    int inputChannels,
    int hiddenChannels,
    int outputChannels,
    int contextChannels,
...
torch::Tensor AdaptiveResNetConvBlockImpl::forward(torch::Tensor x, const torch::Tensor& context)
{
