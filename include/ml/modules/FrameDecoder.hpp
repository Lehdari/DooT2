...
private:
    ...
    torch::nn::ConvTranspose2d  _convTranspose5_Y;
    torch::nn::ConvTranspose2d  _convTranspose5_UV;
    torch::nn::BatchNorm2d      _bnDec5;
    ResNeXtModule               _resNext6;
    torch::nn::ConvTranspose2d  _convTranspose6;
    torch::nn::ConvTranspose2d  _convTranspose6_Y;
    torch::nn::ConvTranspose2d  _convTranspose6_UV;
    torch::nn::BatchNorm2d      _bnDec6;
    ResNeXtModule               _resNext7;
    torch::nn::ConvTranspose2d  _convTranspose7_Y;
